...
app.directive('mySkill', function(){
    return {
        ...
        controller: function($scope){
            $scope.skills = [
                            {name:"Programming Language",value:"JavaEE, Perl, PHP, Hibernate , Spring"},
                            {name:"Front-End Technology",value:"HTML 4/5, Javascript MVC, AJAX, CSS3, JQuery,Bootstrap, Angular, Ember , HandleBars , JSP"},
                            {name:"Web Services",value:"SOAP, Rest"},
                            {name:"Application/Web Servers",value:"Apache Tomcat , GlassFish"},
                            {name:"Databases",value:"SQL Server 2005/08/12, MySQL,PL/SQL, Oracle 11g, Oracle 12c, Elasticsearch"},
                            {name:"IDE Tools",value:"Eclipse, NetBeans, SQL Developer ,WebStorm , Sqlyog"},
